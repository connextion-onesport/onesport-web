...
export default function OrderByDialog({
  onOrder,
  order,
}: {
  ...
  return (
    <Dialog open={isOpen} onOpenChange={setIsOpen}>
      <DialogTrigger
        aria-label="Open Order By Dialog"
      ...
      <DialogContent className="m-0 max-h-screen max-w-max overflow-y-auto p-0">
        <VisuallyHidden>
          <DialogHeader>
...
function OrderByFooter({onApply}: {onApply: () => void}) {
  return (
