'use client';
import useVenueDetails from '@/components/useVenueDetails';
import {useState} from 'react';
import {Button} from '@/components/ui/button';
import {fasilitasDummy} from '@/lib/constants';
import {ratingAndReview} from '@/lib/constants';
import BookingField from '@/components/BookingField';
import Image from 'next/image';
import useFieldRecommendation from '@/components/useFieldRecommendation';
import SportFieldItem from '@/components/SportFieldItem';
...
function VenueDetails() {
  const {data, isLoading, isError, isSuccess} = useVenueDetails();
...
function FieldRecommendation() {
  const {data, isError, isSuccess} = useFieldRecommendation();
  return (
